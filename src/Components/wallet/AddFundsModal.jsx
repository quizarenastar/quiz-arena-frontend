...
function AddFundsModal({
    ...
    return (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4'>
            <div className='bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[95vh] overflow-y-auto'>
                ...
                <div className='flex space-x-4'>
                    <button
                        ...
                        className='flex-1 px-4 py-3 bg-green-600 hover:bg-green-700 disabled:bg-gray-500 text-white rounded-lg font-medium transition-colors'
                    >
                        {addingFunds
                            ? 'Submitting Request...'
                            : 'Submit Request'}
