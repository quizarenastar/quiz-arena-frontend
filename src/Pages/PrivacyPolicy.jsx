    ...
    return (
        <div className='min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300'>
            ...
            <div className='relative overflow-hidden'>
                <div className='absolute inset-0 bg-gradient-to-br from-blue-50 opacity-10 dark:opacity-20'></div>
                <div className='relative container mx-auto px-4 pt-6 sm:pt-12'>
            ...
            <div className='container mx-auto px-4 py-12 space-y-16'>
                ...
                <section className='max-w-4xl mx-auto'>
                    <div className='bg-gradient-to-r from-blue-400 to-gray-400 rounded-3xl p-1 shadow-2xl'>
                        <div className='bg-white dark:bg-gray-800 rounded-3xl p-8'>
                            <div className='flex items-start gap-4'>
                                <div className='flex-shrink-0 w-12 h-12 bg-amber-100 dark:bg-blue-600 rounded-xl flex items-center justify-center'>
                                    <AlertCircle className='w-6 h-6 text-blue-500 dark:text-gray-400' />
                                </div>
                                <div>
                                    <h3 className='text-xl font-bold text-gray-600 dark:text-white mb-3'>
                                        Important Notice
                                    </h3>
                ...
                {/* Contact Section */}
                <section className='max-w-4xl mx-auto'>
                    <div className='text-center  from-blue-50'>
                        <div className='inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-600 to-gray-400 rounded-2xl mb-6 shadow-lg'>
                        ...
                        <button className='inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-gray-400 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:-translate-y-1 transition-all duration-300'>
